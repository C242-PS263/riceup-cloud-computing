    ...
    <>
      <div className="h-screen flex items-center justify-center">
        <div className="container mx-2 lg:mx-10 py-10 bg-background text-foreground flex lg:flex-row flex-col lg:gap-10 lg:justify-center">
          ...
          {prediction && (
            <>
              <Card className="mt-8 lg:mt-0 lg:mx-0">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <Button className="w-full bg-primary text-primary-foreground mt-10" onClick={handleGetAdvice} disabled={adviceLoading}>
                    {adviceLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                    {adviceLoading ? 'Memproses...' : 'Get Advice'}
                  </Button>
                </CardContent>
              </Card>
            </>
